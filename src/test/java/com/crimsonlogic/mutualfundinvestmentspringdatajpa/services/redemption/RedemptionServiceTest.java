...
import com.crimsonlogic
        .mutualfundinvestmentspringdatajpa
        .exception.InsufficientUnitsException;
...
class RedemptionServiceTest {
    ...
    @Test
    void shouldCalculateRedemptionPreview()
        ...
        assertEquals(
                5,
                result.getBrokerageCharges()
        );


        assertEquals(
                585,
                result.getAmountReceived()
        );


        assertNull(
                result.getRedemptionId()
        );
    }
