...
class InvestmentTest {
 @Test void shouldStoreInvestmentDetailsAndRelationships(){
  Investment i=new Investment();
  Investor inv=new Investor();
  EquityFund f=new EquityFund();
 i.setInvestmentId("INVT001");
 i.setInvestor(inv);
 i.setMutualFund(f);
 i.setUnitsPurchased(20);
 i.setInvestmentYears(5);
 i.setAssetGainPerYear(1400);
 i.setAssetGainTotalInvestedYears(7000);
